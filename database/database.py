...
#     (1, 'Asia', 1000000000.00, 250000000.00),  -- Asia excluding Pacific countries
...
#     (6, 'Oceania', 800000000.00, 200000000.00); """)
# conn.commit()
...
#     (15, 3, 'Jamaica', 25000000.00, 5000000.00, 12000000.00, 3000000.00, 10000000.00, 2000000.00, 22000000.00, 3500000.00),
...
#     (26, 6, 'Australia', 80000000.00, 20000000.00, 50000000.00, 15000000.00, 30000000.00, 10000000.00, 160000000.00, 50000000.00),
#     (27, 6, 'New Zealand', 50000000.00, 10000000.00, 25000000.00, 7500000.00, 20000000.00, 5000000.00, 95000000.00, 25000000.00),
#     (28, 6, 'Fiji', 20000000.00, 5000000.00, 10000000.00, 2500000.00, 8000000.00, 2000000.00, 38000000.00, 10000000.00),
#     (29, 6, 'Papua New Guinea', 30000000.00, 7000000.00, 15000000.00, 4000000.00, 12000000.00, 3000000.00, 57000000.00, 13000000.00),
#     (30, 6, 'Samoa', 15000000.00, 3500000.00, 8000000.00, 2000000.00, 6000000.00, 1500000.00, 33000000.00, 7000000.00);"""
...
# cursor.execute("""
# INSERT INTO Users (
#     UserID, Name, Role, Email, Password, AccessedRegions) VALUES
#     (1, 'Alice', 'user', 'alice.smith@example.com', 'alicepass123', '["North America", "Europe"]'),
#     (2, 'Bob', 'admin', 'bob.jones@example.com', 'bobpass456', '["North America", "Oceania"]'),
#     (3, 'Charlie', 'user', 'charlie.brown@example.com', 'charliepass789', '["Europe", "Asia"]'),
#     (4, 'Diana', 'user', 'diana.prince@example.com', 'dianapass101', '["Oceania", "Asia"]'),
...
#     (7, 'George', 'user', 'george.smith@example.com', 'georgepass404', '["Asia", "North America"]'),
#     (8, 'Hannah', 'user', 'hannah.montana@example.com', 'hannahpass505', '["Europe", "Oceania"]'),
#     (9, 'Isaac', 'admin', 'isaac.newton@example.com', 'isaacpass606', '["North America", "Africa", "Oceania"]'),
#     (10, 'Jasmine', 'user', 'jasmine.lee@example.com', 'jasminepass707', '["Asia", "Europe"]'),
#     (11, 'Liam', 'admin', 'liam.connor@example.com', 'liampass808', '["North America", "Africa"]'),
#     (12, 'Mia', 'user', 'mia.williams@example.com', 'miapass909', '["South America", "Asia"]'),
#     (13, 'Noah', 'user', 'noah.johnson@example.com', 'noahpass1010', '["North America", "South America"]'),
#     (14, 'Olivia', 'user', 'olivia.martin@example.com', 'oliviapass1111', '["Europe", "Asia"]'),
#     (15, 'Parker', 'admin', 'parker.james@example.com', 'parkerpass1212', '["Europe", "North America"]'),
#     (16, 'Quinn', 'user', 'quinn.rodriguez@example.com', 'quinnpass1313', '["Oceania", "South America"]'),
#     (17, 'Ryan', 'user', 'ryan.smith@example.com', 'ryanpass1414', '["Asia", "Africa"]'),
#     (18, 'Sophia', 'user', 'sophia.garcia@example.com', 'sophiapass1515', '["North America", "Asia"]'),
#     (19, 'Tyler', 'user', 'tyler.brown@example.com', 'tylerpass1616', '["South America", "Europe"]'),
#     (20, 'Uma', 'admin', 'uma.kumar@example.com', 'umapass1717', '["Oceania", "Africa", "Europe"]');""")
# conn.commit()
